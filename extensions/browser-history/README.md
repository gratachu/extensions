...
Search and open Google Chrome, Mozilla Firefox, Safari, Microsoft Edge, Brave, Vivaldi, Arc, Opera, Iridium, Orion, Sidekick and Dia tabs from search query based on browser history from all browsers.
